...
import { ArrowLeft, CreditCard, Shield, MapPin, Users, Calendar } from 'lucide-react';
import { toast } from 'sonner';

export default function CheckoutForm({ initial }) {
  const router = useRouter();
  const { destinationId, name: destinationName, price: initialPrice } = initial || {};
    ...
    <div className="min-h-screen my-3 bg-gradient-to-br from-slate-800 to-slate-900">
      ...
      <div className="bg-slate-900 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <Button onClick={() => router.back()} className="flex items-center gap-2 text-gray-300 hover:text-blue-600">
            <ArrowLeft className="w-5 h-5" />
            Back
          </Button>
          <h1 className="text-2xl font-bold text-blue-600">Secure Checkout</h1>
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <input
                      ...
                      className="flex-1 px-4 py-2 mt-2  bg-slate-900 text-gray-400 rounded-md border-1 border-gray-400  focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
                      required
                    />
                  </div>
                </div>
            ...
            <div className="bg-slate-900 rounded-xl p-6 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    className='px-4 py-2 mt-2  bg-slate-900 text-gray-400 rounded-md border-1 border-gray-400  focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring'
                    type="text"
                    name="firstName"
          ...
          <div className="lg:col-span-1">
            <div className="bg-slate-900 rounded-xl p-6 shadow-lg sticky top-24">
              ...
              <div className="border-2 border-gray-400 rounded-lg p-4 mb-6">
                <h3 className="font-bold text-lg text-gray-200 mb-2">{destinationName}</h3>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="border-t pt-3 flex justify-between text-xl font-bold text-gray-200">
                  <span>Total:</span>
